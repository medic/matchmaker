 ...
 *
 * Modifications (denoted with comments) by Valerie Roske (@var34) 
 *
*/
if(jQuery) (function($) {
	...
	function hide(event) {
		...
		if( targetGroup && targetGroup.is('.dropdown') ) {
			...
			if( targetGroup.is('.dropdown-menu') ) {
				...
				if( !targetGroup.is('img') ) return; // @var34: changed to support images as options
			} else {
